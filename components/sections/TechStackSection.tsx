                ...
                <div className="space-y-3">
                  {category.techs.map((tech, techIndex) => (
                    <motion.div
                      ...
                      className="bg-gray-50 rounded-lg p-3 text-center font-medium text-gray-700 hover:bg-gray-100 transition-colors cursor-default"
                    >
                      {tech}
                    </motion.div>
                  ))}
