...
export function OutsourcingDetail() {
  const { heading, benefits, models, process, cta } = serviceData.outsourcingData;
    ...
    <div className="pt-20 min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((benefit) => (
              <div key={benefit} className="flex items-center space-x-3 bg-white rounded-lg p-4 shadow-lg">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-900">Outsourcing Models</h2>
