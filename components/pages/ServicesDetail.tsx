            ...
            >
              ...
              <div className="border-t pt-6 mt-6">
                ...
                {service?.active ? (
                  ...
                  <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-xl text-transparent py-2 rounded-lg font-semibold transform  flex items-center justify-start cursor-text">
