            ...
            {cta.buttons.map((btn) =>
              btn.primary ? (
                ...
                <Link
                  key={btn.label}
                  href={btn.href}
                  className="border-2 border-white text-white px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-blue-600 transition-all duration-200 text-center"
                >
                  {btn.label}
                </Link>
              )
